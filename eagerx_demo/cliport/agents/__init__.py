from eagerx_demo.cliport.agents.transporter_lang_goal import (
    TwoStreamClipLingUNetLatTransporterAgent,
    DummyTwoStreamClipLingUNetLatTransporterAgent,
)
...
names = {
    ...
    "dummy_cliport": DummyTwoStreamClipLingUNetLatTransporterAgent,
