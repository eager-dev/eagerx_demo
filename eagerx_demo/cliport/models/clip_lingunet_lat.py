...
import eagerx_demo.cliport.utils.utils as utils
from eagerx_demo.cliport.models.resnet import IdentityBlock, ConvBlock
from eagerx_demo.cliport.models.core.unet import Up
from eagerx_demo.cliport.models.core.clip import build_model, load_clip, tokenize

from eagerx_demo.cliport.models.core import fusion
from eagerx_demo.cliport.models.core.fusion import FusionConvLat
...
class DummyCLIPLingUNetLat(nn.Module):
    """CLIP RN50 with U-Net skip connections and lateral connections"""

    def __init__(self, input_shape, output_dim, cfg, device, preprocess, clip_rn50=None):
        super(DummyCLIPLingUNetLat, self).__init__()
        self.input_shape = input_shape
        self.output_dim = output_dim
        self.input_dim = 2048  # penultimate layer channel-size of CLIP-RN50
        self.cfg = cfg
    ...
    def _build_decoder(self):
        ...
        # vision
        self.conv1 = nn.Sequential(
            nn.Conv2d(self.input_dim, 512, kernel_size=3, stride=1, padding=1, bias=False), nn.ReLU(True)
        )
        # self.up1 = Up(2048, 1024 // self.up_factor, self.bilinear)
        # self.lat_fusion1 = FusionConvLat(input_dim=1024 + 512, output_dim=512)
