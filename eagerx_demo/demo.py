...
from eagerx_demo.cliport.dataset import RavensDataset, RavensMultiTaskDataset
...
@hydra.main(config_path="./cliport/cfg", config_name='train')
def main(cfg):
    # Logger
...
if __name__ == '__main__':
    root = Path(eagerx_demo.__file__).parent.parent
    os.environ["CLIPORT_ROOT"] = str(root)
    main()
